...
const DashboardView = () => {
    ...
    const totalPesananData = [
        ...
        { name: 'Pantai Sanur', value: 13.1, color: '#F4D03F' },
        { name: 'Raja Ampat', value: 13.1, color: '#85C1E9' },
    ...
    return (
        <div className='p-6 bg-gray-50 min-h-screen'>
            ...
            <div className='flex justify-end mb-6'>
                <button className='bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium'>Filter</button>
            </div>
