...
export const useTransportationCompanyParams = (args: PaginationArgs<any>) => {
    ...
    const endpoint = queryString.stringifyUrl({
        url: getApi('transportation_company'),
        query,
    })
    ...
    return useQuery({
        ...
        queryKey: ['LIST_TRANSPORTATION_COMPANY_ALL', query, args],
    })
}
